public class V1SurveyModelGenerator : ISurveyModelGenerator
{
    ...
    public Question createGrainProductsQuestion()
    {
        Question question = new Question()
        {
            QuestionName = "How much grain products do you eat?",
            Description = "Select the foods you eat and enter how much and how often you eat them.",
            Tips = [],
            AllowCustomOptions = false,
            AllowReusableQuestionOptions = false,
            QuestionOptions = [],
            ReusableQuestionOptionsTags = ["food", "grain-products"],
        };

        question.QuestionOptions.Add(createRiceQuestionOption());
        question.QuestionOptions.Add(createPastaQuestionOption());
        question.QuestionOptions.Add(createBreadQuestionOption());
        question.QuestionOptions.Add(createOatmealQuestionOption());
        question.QuestionOptions.Add(createCerealsQuestionOption());
        question.QuestionOptions.Add(createOtherGrainsQuestionOption());

        return question;

        QuestionOption createRiceQuestionOption()
        {
            StandardQuestionOption questionOption = new StandardQuestionOption
            {
                Name = "Rice",
        ...
        QuestionOption createPastaQuestionOption()
        {
            StandardQuestionOption questionOption = new StandardQuestionOption
            {
                Name = "Pasta",
        ...
        QuestionOption createBreadQuestionOption()
        {
            StandardQuestionOption questionOption = new StandardQuestionOption
            {
                Name = "Bread",
        ...
        QuestionOption createOatmealQuestionOption()
        {
            StandardQuestionOption questionOption = new StandardQuestionOption
            {
                Name = "Oatmeal",
        ...
        QuestionOption createCerealsQuestionOption()
        {
            StandardQuestionOption questionOption = new StandardQuestionOption
            {
                Name = "Cereals",
        ...
        QuestionOption createOtherGrainsQuestionOption()
        {
            StandardQuestionOption questionOption = new StandardQuestionOption
            {
                Name = "Other grain products",
                Tags = [],
                IsSelected = false,
                SubQuestions = [],
                DisplaySubQuestions = [],
    ...
    public Question createOtherFoodsQuestion()
    {
        Question question = new Question()
        {
            QuestionName = "How much of these other foods do you eat?",
            Description = "Select the foods you eat and enter how much and how often you eat them.",
            Tips = [],
            AllowCustomOptions = false,
            AllowReusableQuestionOptions = false,
            QuestionOptions = [],
            ReusableQuestionOptionsTags = ["food", "other-foods"],
        };

        question.QuestionOptions.Add(createChocolateQuestionOption());
        question.QuestionOptions.Add(createCoffeeQuestionOption());
        question.QuestionOptions.Add(createPeanutsQuestionOption());
        question.QuestionOptions.Add(creatOtherNutsQuestionOption());
        question.QuestionOptions.Add(createOliveOilQuestionOption());
        question.QuestionOptions.Add(createOtherOilQuestionOption());
        question.QuestionOptions.Add(createWineQuestionOption());
        question.QuestionOptions.Add(createBeerQuestionOption());
        question.QuestionOptions.Add(createSugarQuestionOption());

        return question;

        QuestionOption createChocolateQuestionOption()
        {
            StandardQuestionOption questionOption = new StandardQuestionOption
            {
                Name = "Chocolate",
        ...
        QuestionOption createCoffeeQuestionOption()
        {
            StandardQuestionOption questionOption = new StandardQuestionOption
            {
                Name = "Coffee",
        ...
        QuestionOption createPeanutsQuestionOption()
        {
            StandardQuestionOption questionOption = new StandardQuestionOption
            {
                Name = "Peanuts",
        ...
        QuestionOption creatOtherNutsQuestionOption()
        {
            StandardQuestionOption questionOption = new StandardQuestionOption
            {
                Name = "Other nuts",
        ...
        QuestionOption createOliveOilQuestionOption()
        {
            StandardQuestionOption questionOption = new StandardQuestionOption
            {
                Name = "Olive oil",
        ...
        QuestionOption createOtherOilQuestionOption()
        {
            StandardQuestionOption questionOption = new StandardQuestionOption
            {
                Name = "Other oil",
        ...
        QuestionOption createWineQuestionOption()
        {
            StandardQuestionOption questionOption = new StandardQuestionOption
            {
                Name = "Wine",
        ...
        QuestionOption createBeerQuestionOption()
        {
            StandardQuestionOption questionOption = new StandardQuestionOption
            {
                Name = "Beer",
        ...
        QuestionOption createSugarQuestionOption()
        {
            StandardQuestionOption questionOption = new StandardQuestionOption
            {
                Name = "Sugar",
    ...
    {
        SurveyCategory purchasingHabits = new SurveyCategory()
        {
            CategoryName = "Purchasing habits",
            Description = "Electronics and clothing",
            Questions = [],
        };

        purchasingHabits.Questions.Add(createClothingQuestion());
        purchasingHabits.Questions.Add(createShoesQuestion());
        purchasingHabits.Questions.Add(createSmallElectronicsQuestion());
        purchasingHabits.Questions.Add(createMediumElectronicsQuestion());
        purchasingHabits.Questions.Add(createLargeElectronicsQuestion());

        surveyModel.SurveyCategories.Add(purchasingHabits);
    }

    public Question createClothingQuestion()
    {
        Question question = new Question()
        {
            QuestionName = "How much clothing do you buy?",
            Description = "Please select the kinds of clothes you buy and how many you buy per year. You can answer in 2 ways: how many pieces of clothing you buy per month/year or how often you buy a piece of clothing.",
            Tips = [],
            AllowCustomOptions = false,
            AllowReusableQuestionOptions = false,
            QuestionOptions = [],
            ReusableQuestionOptionsTags = ["purchasing-habits", "clothing"],
        };

        question.QuestionOptions.Add(createLightTopsQuestionOption());
        question.QuestionOptions.Add(createBigTopsQuestionOption());
        question.QuestionOptions.Add(createTrousersQuestionOption());
        question.QuestionOptions.Add(createShortsAndSkirtsQuestionOption());
        question.QuestionOptions.Add(createWinterCoatsQuestionOption());
        question.QuestionOptions.Add(createLightCoatsQuestionOption());
        question.QuestionOptions.Add(createSmallStuffQuestionOption());

        return question;

        StandardQuestionOption createLightTopsQuestionOption()
        {
            StandardQuestionOption questionOption = new StandardQuestionOption
            {
                Name = "Light tops",
        ...
        StandardQuestionOption createBigTopsQuestionOption()
        {
            StandardQuestionOption questionOption = new StandardQuestionOption
            {
                Name = "Big tops",
        ...
        StandardQuestionOption createTrousersQuestionOption()
        {
            StandardQuestionOption questionOption = new StandardQuestionOption
            {
                Name = "Trousers",
        ...
        StandardQuestionOption createShortsAndSkirtsQuestionOption()
        {
            StandardQuestionOption questionOption = new StandardQuestionOption
            {
        ...
        StandardQuestionOption createWinterCoatsQuestionOption()
        {
            StandardQuestionOption questionOption = new StandardQuestionOption
            {
                Name = "Winter coats",
        ...
        StandardQuestionOption createLightCoatsQuestionOption()
        {
            StandardQuestionOption questionOption = new StandardQuestionOption
            {
                Name = "Light coats",
        ...
        StandardQuestionOption createSmallStuffQuestionOption()
        {
            StandardQuestionOption questionOption = new StandardQuestionOption
            {
                Name = "Small stuff",
    ...
    public Question createShoesQuestion()
    {
        Question question = new Question()
        {
            QuestionName = "How many shoes do you buy?",
            Description = "Please select the kinds of shoes you buy and how many you buy per year. You can answer in 2 ways: how many shoes you buy per month/year or how often you buy shoes.",
            Tips = [],
            AllowCustomOptions = false,
            AllowReusableQuestionOptions = false,
            QuestionOptions = [],
            ReusableQuestionOptionsTags = ["purchasing-habits", "shoes"],
        };

        question.QuestionOptions.Add(createLightShoesQuestionOption());
        question.QuestionOptions.Add(createAverageShoesQuestionOption());
        question.QuestionOptions.Add(createLargeShoesQuestionOption());
        question.QuestionOptions.Add(createHeavyBootsQuestionOption());

        return question;

        StandardQuestionOption createLightShoesQuestionOption()
        {
            StandardQuestionOption questionOption = new StandardQuestionOption
            {
                Name = "Light shoes",
        ...
        StandardQuestionOption createAverageShoesQuestionOption()
        {
            StandardQuestionOption questionOption = new StandardQuestionOption
            {
                Name = "Average shoes",
        ...
        StandardQuestionOption createLargeShoesQuestionOption()
        {
            StandardQuestionOption questionOption = new StandardQuestionOption
            {
                Name = "Large shoes",
        ...
        StandardQuestionOption createHeavyBootsQuestionOption()
        {
            StandardQuestionOption questionOption = new StandardQuestionOption
            {
                Name = "Heavy boots",
    ...
    public Question createSmallElectronicsQuestion()
    {
        Question question = new Question()
        {
            QuestionName = "How many small electronics do you buy?",
            ...
            AllowReusableQuestionOptions = false,
            QuestionOptions = [],
            ReusableQuestionOptionsTags = ["purchasing-habits", "small-electronics"],
        };

        question.QuestionOptions.Add(createPhoneQuestionOption());
        question.QuestionOptions.Add(createTabletQuestionOption());
        question.QuestionOptions.Add(createHeadphonesQuestionOption());
        question.QuestionOptions.Add(createCameraQuestionOption());
        question.QuestionOptions.Add(createOtherSmallElectronicsQuestionOption());

        return question;

        StandardQuestionOption createPhoneQuestionOption()
        {
            StandardQuestionOption questionOption = new StandardQuestionOption
            {
                Name = "Smartphone",
            ...
            SubQuestion perTimeframeSubQuestion = new SubQuestion()
            {
                Question = "How many phones do you buy per month/year?",
                Description = "",
                QuestionType = QuestionType.intInput,
                Answer = "",
                UnitOptions = ["Per year", "Per month"],
            ...
            SubQuestion secondHandSubQuestion = new SubQuestion()
            {
                Question = "Second hand phones",
                Description = "What percentage of the phones you buy are second hand?",
                QuestionType = QuestionType.percentage,
                Answer = "",
                SubQuestionKey = V1SubQuestionKeys.purchasing_second_hand_percentage,
            };
        ...
        StandardQuestionOption createTabletQuestionOption()
        {
            StandardQuestionOption questionOption = new StandardQuestionOption
            {
                Name = "Tablet",
            ...
            SubQuestion perTimeframeSubQuestion = new SubQuestion()
            {
                Question = "How many tablets do you buy per month/year?",
                Description = "",
                QuestionType = QuestionType.intInput,
                Answer = "",
                UnitOptions = ["Per year", "Per month"],
            ...
            SubQuestion frequencySubQuestion = new SubQuestion()
            {
                Question = "How often do you buy a tablet?",
                Description = "",
                QuestionType = QuestionType.intInput,
                Answer = "",
                UnitOptions = ["years", "months"],
        ...
        StandardQuestionOption createHeadphonesQuestionOption()
        {
            StandardQuestionOption questionOption = new StandardQuestionOption
            {
                Name = "Headphones",
            ...
            SubQuestion perTimeframeSubQuestion = new SubQuestion()
            {
                Question = "How many headphones do you buy per month/year?",
                Description = "",
                QuestionType = QuestionType.intInput,
                Answer = "",
                UnitOptions = ["Per year", "Per month"],
            ...
            SubQuestion secondHandSubQuestion = new SubQuestion()
            {
                Question = "Second hand headphones",
                Description = "What percentage of the phones you buy are second hand?",
                QuestionType = QuestionType.percentage,
                Answer = "",
                SubQuestionKey = V1SubQuestionKeys.purchasing_second_hand_percentage,
        ...
        StandardQuestionOption createCameraQuestionOption()
        {
            StandardQuestionOption questionOption = new StandardQuestionOption
            {
                Name = "Camera",
            ...
            SubQuestion perTimeframeSubQuestion = new SubQuestion()
            {
                Question = "How many cameras do you buy per month/year?",
                Description = "",
                QuestionType = QuestionType.intInput,
                Answer = "",
                UnitOptions = ["Per year", "Per month"],
            ...
            SubQuestion frequencySubQuestion = new SubQuestion()
            {
                Question = "How often do you buy a camera?",
                Description = "",
                QuestionType = QuestionType.intInput,
                Answer = "",
                UnitOptions = ["years", "months"],
            ...
            SubQuestion secondHandSubQuestion = new SubQuestion()
            {
                Question = "Second hand cameras",
                Description = "What percentage of the cameras you buy are second hand?",
                QuestionType = QuestionType.percentage,
                Answer = "",
                SubQuestionKey = V1SubQuestionKeys.purchasing_second_hand_percentage,
            };
        ...
        StandardQuestionOption createOtherSmallElectronicsQuestionOption()
        {
            StandardQuestionOption questionOption = new StandardQuestionOption
            {
                Name = "Other small electronics",
                Tags = [],
                IsSelected = false,
                SubQuestions = [],
                DisplaySubQuestions = [],
    ...
    public Question createLargeElectronicsQuestion()
    {
        Question question = new Question()
        {
            QuestionName = "How many large electronics do you buy?",
            Description = "Please select the kinds of electronics you buy and how many you buy. You can answer in 2 ways: how many electronics you buy per month/year or how often you buy electronics.",
            Tips = [],
            AllowCustomOptions = false,
            AllowReusableQuestionOptions = false,
            QuestionOptions = [],
            ReusableQuestionOptionsTags = ["purchasing-habits", "large-electronics"],
        };

        question.QuestionOptions.Add(createTVQuestionOption());
        question.QuestionOptions.Add(createLargeSpeakersQuestionOption());
        question.QuestionOptions.Add(createMediumHouseholdAppliancesQuestionOption());
        question.QuestionOptions.Add(createLargeHouseholdAppliancesQuestionOption());
        question.QuestionOptions.Add(createOtherLargeElectronicsQuestionOption());

        return question;

        StandardQuestionOption createTVQuestionOption()
        {
            StandardQuestionOption questionOption = new StandardQuestionOption
            {
                Name = "Tv",
            ...
            SubQuestion perTimeframeSubQuestion = new SubQuestion()
            {
                Question = "How many tv's do you buy per month/year?",
                Description = "",
                QuestionType = QuestionType.intInput,
                Answer = "",
                UnitOptions = ["Per year", "Per month"],
            ...
            SubQuestion frequencySubQuestion = new SubQuestion()
            {
                Question = "How often do you buy a tv?",
                Description = "",
                QuestionType = QuestionType.intInput,
                Answer = "",
                UnitOptions = ["years", "months"],
            ...
            SubQuestion secondHandSubQuestion = new SubQuestion()
            {
                Question = "Second hand tv",
                Description = "What percentage of the tv's you buy are second hand?",
                QuestionType = QuestionType.percentage,
                Answer = "",
                SubQuestionKey = V1SubQuestionKeys.purchasing_second_hand_percentage,
            };
        ...
        StandardQuestionOption createLargeSpeakersQuestionOption()
        {
            StandardQuestionOption questionOption = new StandardQuestionOption
            {
                Name = "Large speakers",
        ...
        StandardQuestionOption createMediumHouseholdAppliancesQuestionOption()
        {
            StandardQuestionOption questionOption = new StandardQuestionOption
            {
                Name = "Medium sized household appliances",
                Tags = [],
                IsSelected = false,
                SubQuestions = [],
                DisplaySubQuestions = [],
            ...
            SubQuestion perTimeframeSubQuestion = new SubQuestion()
            {
                Question = "How many appliances do you buy per month/year?",
                Description = "",
                QuestionType = QuestionType.intInput,
                Answer = "",
                UnitOptions = ["Per year", "Per month"],
            ...
            SubQuestion frequencySubQuestion = new SubQuestion()
            {
                Question = "How often do you buy an appliance?",
                Description = "",
                QuestionType = QuestionType.intInput,
                Answer = "",
                UnitOptions = ["years", "months"],
        ...
        StandardQuestionOption createLargeHouseholdAppliancesQuestionOption()
        {
            StandardQuestionOption questionOption = new StandardQuestionOption
            {
        ...
        StandardQuestionOption createOtherLargeElectronicsQuestionOption()
        {
            StandardQuestionOption questionOption = new StandardQuestionOption
            {
                Name = "Other large electronics",
                Tags = [],
                IsSelected = false,
                SubQuestions = [],
                DisplaySubQuestions = [],
